...
@php
    ...
    $fillPercent = min(100, ($class->bookings_count / $class->capacity) * 100);
@endphp
...
<!-- ================= DIGITAL MEMBER QR BADGE ================= -->

@if(auth()->check())

<div class="mt-20 bg-white p-10 rounded-3xl shadow-xl max-w-md mx-auto text-center">
...
new QRCode(document.getElementById("qrcode"), {
    text: "Member-{{ auth()->id() }}-VaultAccess",
    width: 150,
    height: 150
});
@endif
